<template>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav">
      ...
      <li>
        <router-link v-if="!isLoggedIn" class="nav-link" :to="{name: 'login'}" >Login</router-link>
      </li>
      <li>
        <router-link v-if="!isLoggedIn" class="nav-link" :to="{name: 'register'}" >Register</router-link>
      </li>
    </ul>
